...
import { PlusCircle, Car, CalendarCheck, MessageSquareQuote } from 'lucide-react';
...
const navLinks = [
    ...
    { path: "/testimonial", icon: MessageSquareQuote, label: "Testimonials" },
];
                        ...
                        <div className={s.contentContainer}>
                            <Link to='/' className={s.logoLink}>
                                <div className={s.logoContainer}>
                                    <img src={logo} alt="logo" className={s.logoImage} style={{
                                        objectFit: "contain",
                                    }}
                                    />
                            ...
                            <div className={s.mobileMenuButton}>
                                <button ref={buttonRef} onClick={() => setIsOpen(!isOpen)} className={s.mobileMenuButton} aria-label="Toggle menu" aria-expanded={isOpen}>
                                    {isOpen ? (
                                        <X className="h-5   w-5" />
                                    ) : (
                ...
                <div ref={menuRef} className={s.mobileMenu}>
                    <div className={s.mobileMenuContainer}>
                        {navLinks.map((link) => {
                            ...
                            return (
                                <Link key={link.path} to={link.path} className={s.mobileNavLink} onClick={() => setIsOpen(false)}>
